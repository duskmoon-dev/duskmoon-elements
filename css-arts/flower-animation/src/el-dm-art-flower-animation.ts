...
const lights = (count: number) =>
  Array.from({ length: count }, (_, i) => `<div class="flower__light flower__light--${i + 1}"></div>`).join('');

const lineLeaves = (count: number) =>
  Array.from({ length: count }, (_, i) => `<div class="flower__line__leaf flower__line__leaf--${i + 1}"></div>`).join('');
...
const grassLeaves = (count: number) =>
  Array.from({ length: count }, (_, i) => `<div class="flower__grass__leaf flower__grass__leaf--${i + 1}"></div>`).join('');
...
const gFrLeafs = (count: number) =>
  Array.from({ length: count }, (_, i) => `<div class="flower__g-fr__leaf flower__g-fr__leaf--${i + 1}"></div>`).join('');
