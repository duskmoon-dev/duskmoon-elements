...
```html
<el-dm-bottom-sheet id="my-sheet">
...
<ComponentDemo title="Bottom Sheet Demo">
  ...
  <el-dm-bottom-sheet id="demo-sheet">
...
<ComponentDemo title="Snap Points">
  ...
  <el-dm-bottom-sheet id="snap-sheet" snap-points="25%,50%,100%">
...
<ComponentDemo title="Persistent Sheet">
  <el-dm-button onclick="document.getElementById('demo-persistent-sheet').show()">Open Persistent Sheet</el-dm-button>
  <el-dm-bottom-sheet id="demo-persistent-sheet" persistent>
    <span slot="header">Persistent Sheet</span>
    <p>This sheet cannot be dismissed by clicking outside or swiping down.</p>
    <el-dm-button onclick="document.getElementById('demo-persistent-sheet').hide()" style="margin-top: 1rem;">Close Button Required</el-dm-button>
  </el-dm-bottom-sheet>
</ComponentDemo>
