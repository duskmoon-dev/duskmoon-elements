...
<ComponentDemo title="Compact Gap (0.5rem)">
  <el-dm-form gap="0.5rem">
    <el-dm-input label="Email" placeholder="Enter email"></el-dm-input>
    <el-dm-input label="Password" type="password" placeholder="Enter password"></el-dm-input>
    <el-dm-button type="submit">Submit</el-dm-button>
  </el-dm-form>
</ComponentDemo>

<ComponentDemo title="Default Gap (1rem)">
  <el-dm-form gap="1rem">
    <el-dm-input label="Email" placeholder="Enter email"></el-dm-input>
    <el-dm-input label="Password" type="password" placeholder="Enter password"></el-dm-input>
    <el-dm-button type="submit">Submit</el-dm-button>
...
<ComponentDemo title="Spacious Gap (2rem)">
  <el-dm-form gap="2rem">
    <el-dm-input label="Email" placeholder="Enter email"></el-dm-input>
    <el-dm-input label="Password" type="password" placeholder="Enter password"></el-dm-input>
    <el-dm-button type="submit">Submit</el-dm-button>
